...
@Service
@Profile("like-search")
public class ContextRetrievalByContentLikeService implements ContextRetrievalService {

    private static final Logger log = LoggerFactory.getLogger(ContextRetrievalByContentLikeService.class);
    ...
    public ContextRetrievalByContentLikeService(ParagraphRepository paragraphRepository) {
